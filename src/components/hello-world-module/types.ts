...
export type HelloWorldModuleCssGroupAttr = FormatBreakpointStateAttr<HelloWorldModuleCssAttr>;

export interface HelloWorldModuleAttrs extends InternalAttrs {
  // CSS options is used across multiple elements inside the module thus it deserves its own top property.
  css?: HelloWorldModuleCssGroupAttr;
