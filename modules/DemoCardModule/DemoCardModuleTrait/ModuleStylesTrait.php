...
trait ModuleStylesTrait {
	 ...
	 * src/components/demo-card-module/styles.tsx.
	 *
	 * @since ??
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$args['orderClass']} .example_demo_card_module__content-container",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => DemoCardModule::custom_css(),
						]
					),
