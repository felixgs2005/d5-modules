...
trait ModuleStylesTrait {
	...
	/**
	 * Movie Card Module's style components.
	 *
	 * This function is equivalent of JS function ModuleStyles located in
	 * src/components/movie-card-module/styles.tsx.
	 *
	 * @since ??
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$args['orderClass']} .example_movie_card_module__content-container",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => MovieCardModule::custom_css(),
						]
					),
