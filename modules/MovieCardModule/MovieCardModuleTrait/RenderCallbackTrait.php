...
trait RenderCallbackTrait {
	...
	/**
	 * Movie Card Module render callback which outputs server side rendered HTML on the Front-End.
	 *
	 * @since ??
	 ...
	 *
	 * @return string HTML rendered of Movie Card Module.
	 */
	public static function render_callback( $attrs, $content, $block, $elements ) {
		//error_log('[MovieCardModule] render_callback called');
    	//error_log('[MovieCardModule] attrs: ' . print_r( $attrs, true ));
